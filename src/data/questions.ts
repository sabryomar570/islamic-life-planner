...
export type Question = {
  ...
  title: string;
  hint: string;
  section: "يومك ونومك" | "صلاتك" | "القرآن والذكر" | "عملك ووقتك" | "رياضتك" | "هدفك وبيئتك";
  kind: QuestionKind;
...
export const QUESTIONS: Question[] = [
  {
    ...
    hint: "حتى لو كان استيقاظك متأخرًا، اصدق مع نفسك لنبني خطة واقعية.",
    section: "يومك ونومك",
    kind: "time",
  },
  {
    key: "sleepTime",
    title: "في أي ساعة تنام عادةً؟",
    hint: "نومك هو أساس يومك، وبه نُحدّد وقت أذكار المساء.",
    section: "يومك ونومك",
    kind: "time",
  },
  {
    ...
    hint: "لا يوجد حكم هنا، فقط نعرف من أين نبدأ معك.",
    section: "صلاتك",
    kind: "choice",
    options: [
      { value: "always", label: "نعم، بانتظام ولله الحمد" },
      { value: "most", label: "أغلب الوقت، وأحيانًا أتأخر" },
      { value: "sometimes", label: "أحيانًا فقط" },
      { value: "starting", label: "لم أبدأ بعد وأريد البدء" },
    ],
  },
  {

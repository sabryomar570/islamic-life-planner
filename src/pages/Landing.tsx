...
const SECTIONS = [
  ...
  },
  {
    icon: BookOpen,
    title: "المصحف",
    text: "١١٤ سورة كاملة بقراءة سلسة متواصلة، والبسملة مفصولة عن السورة، ويحفظ موضعك وينزل كاملًا للقراءة بلا إنترنت.",
  },
  {
    icon: HeartHandshake,
    title: "أدعية مأثورة",
          ...
          <div>
            ...
            <ul className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-[11px] text-muted-foreground">
              {[
                ...
                "كل نص بمصدره وراويه",
                "لا إعلانات، ولا يغادر موقعك جهازك إلا لخدمة المواقيت",
